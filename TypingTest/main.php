...
<html lang="en">
    ...
    <body style="background-color:#ffe4e1;">
        <center><h1 style="color: black;font-size: 50px;margin-bottom: -10px;">AKATSUKI TYPING TEST</h1></center>
        ...
        <div style="margin-top:5%">
            <div style="background-color: #a0d2eb;color: black;">
                <center>
        ...
        <center>
        <img src="Akatsuki.jpg" alt="akatsuki" width=200 height=150>
        </center
    </body>
</html>
